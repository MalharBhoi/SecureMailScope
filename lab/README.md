...
```
.venv/bin/python -m securemailscope.ml.captured_dataset lab/output/manifest.json lab/output/dataset.jsonl
.venv/bin/python -m securemailscope.ml.train --dataset lab/output/dataset.jsonl --artifacts lab/output/candidate
```
