...
from securemailscope.net.reassembly import Direction, Reassembler, seq_delta
from securemailscope.pcap.layers import parse_ip_tcp, strip_link_layer
from securemailscope.pcap.reader import CaptureFormatError, CaptureReader
...
def test_reassembly_has_no_gaps_on_demo_captures(captures):
    for key, path in captures.items():
        reader = CaptureReader(path)
        from securemailscope.net.reassembly import reassemble
