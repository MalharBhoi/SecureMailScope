...
from securemailscope.analyze import tls
from securemailscope.analyze.ciphers import properties, suite_name
from securemailscope.analyze.starttls import (
    DialogueLine,
    analyse,
...
def test_find_tls_start_locates_a_real_handshake(captures):
    ...
    from securemailscope.pcap.reader import CaptureReader
