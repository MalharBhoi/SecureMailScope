 ...
 *
 * <p>There is exactly one knob that matters: {@code sms.engine.python}, the
 ...
 *
 * <p>This used to also carry {@code sms.engine.path}, a directory that was put
 ...
 */
@ConfigurationProperties(prefix = "sms.engine")
